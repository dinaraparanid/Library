...
namespace booksys
{
	...
	public:
		Book(std::string title, std::string author) noexcept : title_(std::move(title)), author_(std::move(author)) {}
		~Book() = default;
	...
	class TheBook : std::enable_shared_from_this<TheBook> // interface
	{
